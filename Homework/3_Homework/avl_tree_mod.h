#ifndef AVL_TREE_MODDED
#define AVL_TREE_MODDED
...
//PRIVATE*********************PRIVATE
  private:
    ...
    void modifiedRemove( int &recursive_calls , int &successful_removes, const Comparable & x, AvlNode * & t )
    {
        recursive_calls++;
        if( t == nullptr )
            ...
            modifiedRemove(recursive_calls, successful_removes, x, t->left );
        else if( t->element < x )
            modifiedRemove(recursive_calls, successful_removes, x, t->right );
